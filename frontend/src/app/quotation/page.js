...
const QuotationPage = () => {
  ...
  if (isLoading) {
    return (
      <section
        className="min-h-screen pt-24 pb-16 lg:py-20 bg-lightBg relative bg-cover bg-fixed bg-no-repeat flex items-center justify-center"
        style={{
  ...
  return (
    <section
      className="min-h-screen pt-24 pb-16 lg:py-20 bg-lightBg relative bg-cover bg-fixed bg-no-repeat"
      style={{
        backgroundImage: "url('/curtains-background.png')",
        backgroundAttachment: "fixed",
        backgroundPosition: "center",
