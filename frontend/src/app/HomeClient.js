...
export default function HomeClient({ content = {} }) {
  ...
  return (
    <div className="bg-lightBg relative min-h-screen">
      <PageBackdrop />

      {/* Sections */}
      <div className="relative z-10">
        <Hero initialContent={content.hero} />
        <AboutFeatures initialContent={content.about} />
        <CollectionsSection initialContent={content.collections} />
        <FeaturedProductsSection initialContent={content.featured} />
        <CurtainHelpSection initialContent={content.help} />
      </div>
