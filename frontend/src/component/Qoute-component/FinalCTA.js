...
const FinalCTA = () => {
  ...
  const ENDPOINT = `${API_BASE}/quote/final-cta/`;
    ...
    const fetchData = async () => {
      try {
        ...
        const defaultData = {
          ...
          description: "Request your free quote today and let our experts help you bring your project to life",
          primaryButton: {
  ...
  const handleBackgroundImageUpload = async (event) => {
    ...
    formData.append("category", "final-cta-background");
    ...
    return (
      <section className="py-32 bg-gradient-to-br from-[#0b1d34] via-[#13344c] to-black relative overflow-hidden flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-300">Loading final CTA section...</p>
        </div>
      </section>
    );
  }
  ...
  if (!data) {
    return (
      <section className="py-32 bg-gradient-to-br from-[#0b1d34] via-[#13344c] to-black relative overflow-hidden flex justify-center items-center">
        <div className="text-center">
          <p className="text-gray-300">Failed to load final CTA section. Please try again later.</p>
        </div>
      </section>
    );
  }
            ...
            {editMode ? (
              <>
                ...
                <div 
                  ...
                  className="cursor-pointer bg-white/10 backdrop-blur-sm text-white px-10 py-6 rounded-xl font-bold text-lg border-2 border-white/20 hover:bg-white hover:text-[#0b1d34] transition-all duration-300 inline-flex items-center justify-center space-x-3 border-dashed"
                >
                  <Phone size={20} />
